  ...
  return (
    <section className="py-24 bg-gray-900 text-gray-100">
      <div className="container mx-auto px-5 max-w-4xl bg-gray-800 rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-bold mb-8">Datenschutz&shy;erkl&auml;rung</h1>
        
        <div className="space-y-8">
          {/* Abschnitt 1 */}
          <div className="bg-gray-700 p-6 rounded-md">
            <h2 className="text-2xl font-semibold mb-4 text-gray-200">1. Datenschutz auf einen Blick</h2>
            
            <h3 className="text-xl font-medium mb-3 text-gray-200">Allgemeine Hinweise</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Datenerfassung auf dieser Website</h3>
            
            <h4 className="text-lg font-medium mb-2 text-gray-200">Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser Website?</h4>
            <p className="mb-4">
            ...
            <h4 className="text-lg font-medium mb-2 text-gray-200">Wie erfassen wir Ihre Daten?</h4>
            <p className="mb-4">
            ...
            <h4 className="text-lg font-medium mb-2 text-gray-200">Wof&uuml;r nutzen wir Ihre Daten?</h4>
            <p className="mb-4">
            ...
            <h4 className="text-lg font-medium mb-2 text-gray-200">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
            <p className="mb-4">
          ...
          {/* Abschnitt 2 */}
          <div className="bg-gray-700 p-6 rounded-md">
            <h2 className="text-2xl font-semibold mb-4 text-gray-200">2. Hosting</h2>
            <p className="mb-4">Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
            
            <h3 className="text-xl font-medium mb-3 text-gray-200">Externes Hosting</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Wir setzen folgende(n) Hoster ein:</h3>
            <p>
              HOSTINGER operations, UAB
              <br />
              &Scaron;vitrigailos str. 34, Vilnius 03230 Litauen
            </p>
          </div>

          {/* Abschnitt 3 */}
          <div className="bg-gray-700 p-6 rounded-md">
            <h2 className="text-2xl font-semibold mb-4 text-gray-200">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
            
            <h3 className="text-xl font-medium mb-3 text-gray-200">Datenschutz</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Hinweis zur verantwortlichen Stelle</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Speicherdauer</h3>
            <p className="mb-4">
              Soweit innerhalb dieser Datenschutzerkl&auml;rung keine speziellere Speicherdauer genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis der Zweck f&uuml;r die Datenverarbeitung entf&auml;llt. Wenn Sie ein berechtigtes L&ouml;schersuchen geltend machen oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gel&ouml;scht, sofern wir keine anderen rechtlich zul&auml;ssigen Gr&uuml;nde f&uuml;r die Speicherung Ihrer personenbezogenen Daten haben (z.&nbsp;B. steuer- oder handelsrechtliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die L&ouml;schung nach Fortfall dieser Gr&uuml;nde.
            </p>
            
            <h3 className="text-xl font-medium mb-3 text-gray-200">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Beschwerde&shy;recht bei der zust&auml;ndigen Aufsichts&shy;beh&ouml;rde</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Auskunft, Berichtigung und L&ouml;schung</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 text-gray-200">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
            <p className="mb-4">
          ...
          {/* Abschnitt 4 */}
          <div className="bg-gray-700 p-6 rounded-md">
            <h2 className="text-2xl font-semibold mb-4 text-gray-200">4. Datenerfassung auf dieser Website</h2>
            
            <h3 className="text-xl font-medium mb-3 text-gray-200">Cookies</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Cookies k&ouml;nnen von us (First-Party-Cookies) oder von Drittunternehmen stammen (sog. Third-Party-Cookies). Third-Party-Cookies erm&ouml;glichen die Einbindung bestimmter Dienstleistungen von Drittunternehmen innerhalb von Webseiten (z.&nbsp;B. Cookies zur Abwicklung von Zahlungsdienstleistungen).
            </p>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-medium mb-3 mt-6 text-gray-200">Anfrage per E-Mail, Telefon oder Telefax</h3>
            <p className="mb-4">
          ...
          <div className="pt-6 border-t border-gray-700">
            <p className="text-gray-400 text-sm">
              Quelle: <a href="https://www.e-recht24.de" className="text-blue-400 hover:text-blue-300">https://www.e-recht24.de</a>
            </p>
          </div>
        </div>
      </div>
